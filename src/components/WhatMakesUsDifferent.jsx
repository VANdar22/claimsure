...
import image1 from "../assets/focus.png";
import image2 from "../assets/knowledge.png";
import image3 from "../assets/ethical.png";
import image4 from "../assets/riskadvisory.png";
            ...
            {features.map((item, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-[#7f1734]/90 p-6 transform translate-y-full group-hover:translate-y-0 transition-all duration-300 text-white h-1/2">
          ...
          >
            <div className="bg-gray-50 p-4 sm:p-6 rounded-2xl shadow-sm border border-gray-100 max-w-4xl mx-auto">
              <div className="flex items-center justify-between flex-nowrap gap-3 sm:gap-6">
                ...
                <button 
                  className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 flex items-center justify-center bg-white text-[#7f1734] border-2 border-[#7f1734] rounded-xl font-medium hover:bg-[#7f1734] hover:text-white transition-colors duration-300 text-xl sm:text-2xl"
